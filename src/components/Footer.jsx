        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Transformamos artículos promocionales en historias que conectan con tu audiencia en todo Ecuador.
            </p>
            {/* Social Links */}
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 border border-gray-600 hover:border-primary hover:bg-primary text-gray-400 hover:text-white flex items-center justify-center transition-all"
                aria-label="Facebook"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-6">Enlaces</h3>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-6">Categorías</h3>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-6">Contacto</h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">Quito, Ecuador</span>
              </div>
              <a
      ...
      <div className="border-t border-gray-700">
        <div className="container mx-auto px-4 py-5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-sm text-gray-500">
            <p>
              © {currentYear} KSPromocionales. Todos los derechos reservados.
            </p>
            <p>
              Desarrollado por{' '}
              <a
